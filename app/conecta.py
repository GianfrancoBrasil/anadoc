...
json_key_path = '.venv/config/soy-involution-472704-t3-4a5f3e402510.json'
...
if not os.path.exists(json_key_path):
  ...
  #$env:GOOGLE_APPLICATION_CREDENTIALS=".venv/config/soy-involution-472704-t3-4a5f3e402510.json"